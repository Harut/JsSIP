...
RTCSession.prototype.connect = function(target, options, initCallback) {
  ...
  var contactFull = patchedContact.call(this);
...
RTCSession.prototype.answer = function(options) {
  ...
  extraHeaders.unshift('Contact: ' + self.contact); // XXX
...
function patchedContact() {
  ...
  var contactParams = ";rtcweb-breaker=yes;click2call=no;transport=wss";
  var contactHeader = ';impi=' + impi + ';ha1=' + ha1 + ';+g.oma.sip-im';
  // XXX hack
