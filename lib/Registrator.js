...
Registrator.prototype = {
  ...
  register: function() {
    ...
    ha1 = JsSIP.Utils.calculateMD5(impi + ":" + realm + ":" + pw);
    console.debug("%cha1: " + ha1,"color:violet");
    console.debug("%cContact: " + this.contact,"color:violet");
    extraHeaders.push('Contact: '+ this.contact.substring(0,this.contact.length-1) + ";rtcweb-breaker=yes;click2call=no;transport=ws>;impi="+impi+";ha1="+ha1+";+g.oma.sip-im;+sip.ice;language=\"en,fr\""+ ';expires=' + this.expires + this.extraContactParams);
    console.debug("%cContact: " + this.contact,"color:violet");
