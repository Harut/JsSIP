...
Registrator.prototype = {
  ...
  register: function() {
    ...
    var impi = this.ua.configuration.authorization_user;
    //var pw = this.ua.configuration.password;
    //var realm = this.ua.configuration.hostport_params
    //var ha1 = Utils.calculateMD5(impi + ":" + realm + ":" + pw);

    var contactSplit = this.contact.split('>');
    var contactParams = ";rtcweb-breaker=yes;transport=wss";
    var contactHeader = ";click2call=no;+g.oma.sip-im;expires=" + this.expires + this.extraContactParams;
    // XXX hack
    // XXX escape display name
    //var contactFull = '"' + impi + '"' + contactSplit[0] + contactParams + '>' + contactSplit[1] + contactHeader;
    // XXX contactSplit[1] breaks everything
    var contactFull = '"' + impi + '"' + contactSplit[0] + contactParams + '>' + contactHeader;

    //console.debug("%cha1: " + ha1,"color:violet");
    extraHeaders.push('Contact: '+ contactFull);
    console.debug("%cContact-old: " + this.contact,"color:violet");
    console.debug("%cContact: " + contactFull,"color:violet");
