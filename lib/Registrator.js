...
Registrator.prototype = {
  ...
  register: function() {
    ...
    var contactHeader = ";click2call=no;impi="+impi+";ha1="+ha1+";+g.oma.sip-im;expires=" + this.expires + this.extraContactParams;
    var contactFull = contactSplit[0] + contactParams + '>' + contactSplit[1] + contactHeader;
