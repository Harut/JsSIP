...
Registrator.prototype = {
  ...
  register: function() {
    ...
    var contactHeader = this.contact.substring(0,this.contact.length-1) + ";rtcweb-breaker=yes;click2call=no;transport=wss>;impi="+impi+";ha1="+ha1+";+g.oma.sip-im;+sip.ice;language=\"en,fr\""+ ';expires=' + this.expires + this.extraContactParams;

    console.debug("%cha1: " + ha1,"color:violet");
    extraHeaders.push('Contact: '+ contactHeader);
    console.debug("%cContact: " + contactHeader,"color:violet");
